...
# theme window(qt-material library themes)
class ThemeWindow(QDialog):
    ...
    def init_themes(self):
        ...
        self.ui.layout_body.addWidget(label, 0, 0, 1, -1)
        ...
        for name in themes:
            ...
            self.ui.layout_body.addWidget(label, row, column)
