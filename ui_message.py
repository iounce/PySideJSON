...
class Ui_MessageWindow(object):
    def setupUi(self, MessageWindow):
        ...
        self.layout_head.setObjectName("layout_head")
    ...
    def retranslateUi(self, MessageWindow):
        ...
        self.lbl_text.setText(
            QCoreApplication.translate("MessageWindow", "title_text", None)
        )
        self.btn_ok.setText(
            QCoreApplication.translate("MessageWindow", "title_ok", None)
        )
        self.btn_cancel.setText(
            QCoreApplication.translate("MessageWindow", "title_cancel", None)
        )
        self.lbl_logo.setText("")
        self.lbl_title.setText(
            QCoreApplication.translate("MessageWindow", "title_this_window", None)
        )
