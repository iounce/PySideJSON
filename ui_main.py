...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layout_foot.setObjectName("layout_foot")
        self.widget_foot = QWidget(self.wid_main)
        self.widget_foot.setObjectName("widget_foot")
        ...
        self.horizontalSpacer = QSpacerItem(
            80, 32, QSizePolicy.Expanding, QSizePolicy.Minimum
        )
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_title.setText(
            QCoreApplication.translate("MainWindow", "title_this_app", None)
        )
